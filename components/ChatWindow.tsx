    ...
    return {
        ...
        director: {
            ...
            ...(situation.director.continueThreshold !== undefined
                ...
                : {}),
            ...(situation.director.protagonistThreshold !== undefined
                ? { protagonistThreshold: situation.director.protagonistThreshold }
                : {}),
        },
    ...
    const generateRustTurn = async (
        ...
        try {
            const accepted = await submitConversationJob<RustTurnResponse>({
                    ...
                    conversationCompressionEnabled,
                    memoryGateModel: serializeModelRef(memoryGateModel),
                    memoryGateEnabled,
                    memoryGateShadowMode,
